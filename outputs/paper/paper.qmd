...
```
We alsonutilized the dataset 'CA1_1969_2013_ALL.csv' to extract three specific rows detailing per capita personal income (in dollars) from 1969 to 2013. To ensure consistency with unemployment rate data, we narrowed the focus to the years 1979 to 1989 (see @tbl-personal-income).
```{r}
#| echo: false
#| message: false
#| warning: false
